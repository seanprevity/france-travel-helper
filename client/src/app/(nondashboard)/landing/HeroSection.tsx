  ...
  return (
    <section className="relative w-full overflow-hidden flex items-center justify-center text-center pt-[50px] h-[calc(100vh-50px)]">
      ...
      <div className="relative z-30 px-4 sm:px-6 lg:px-10 flex flex-col items-center justify-center text-white">
        <h1 className={`${playfair.className} text-4xl sm:text-5xl md:text-6xl mb-4 font-bold drop-shadow-md tracking-tight`}>
          {t("heroTitle")}
        </h1>
        <p className={`${lato.className} text-lg sm:text-xl md:text-2xl max-w-3xl mb-8 font-light drop-shadow-sm`}>
          {t("heroSubtitle")}
        </p>
        <button
